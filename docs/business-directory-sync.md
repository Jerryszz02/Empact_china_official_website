...
依据工作区的 `Empact网站业务目录.xlsx`，工作表为「业务目录」；初次同步于 2026-09-19，增补于 2026-09-20。仅把表格中的业务名称、案例、链接和附件作为内容来源；负责人提醒、协作备注及空案例位不进入网站。原工作簿和既有素材整理保持原样。
...
| 企业业务   | 企业志愿者、CSR与公益咨询；AI×组织变革与智能赋能；领导力激发与体验创新；职场心理韧性培养与压力释放；商学院管理创新学科课程 |
...
| 表格位置        | 项目                             | 已有信息与所缺资料                                                                                                                                |
| --------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| D6/F6           | 自研六大模型                     | 有研发者与国际参考框架说明；本地 IDG 解读 PPT 介绍了 IDG 与体验式、服务式、PBL 学习，没有六大自研模型的完整定义。需要该版本的六个名称、说明与图示 |
| D7/F7           | 日本国际研学营                   | 有项目名称、在线营前会索引与一张不能用于核实事实的照片；需营前会、实际行程或回顾                                                                  |
| D8/F8/G8        | 中欧校友 AI×SDGs 之旅            | 12 条链接已全部匹配其他月月营；微软项目已根据海报补文。中欧这一项尚缺专用活动介绍、行程、回顾或推文链接                                           |
...
月月营十四项中，十二项按已核对推文直接跳转，微软项目按活动海报生成站内介绍，中欧校友 AI×SDGs 之旅等待补充资料。善淘慈善超市和波克年度沙龙均有对应链接。
