...
| ICP/公安备案信息、备案覆盖确认 | 页脚和正式上线审查 | 2026-09-24 已核实：`沪ICP备2026002363号-2` 即 empact.cn 本站备案号（阿里云控制台备案信息），页脚公示正确；公安备案已办妥：`沪公网安备31010402337130号`（徐汇区网安支队，2026-09-14，主域名 empact.cn），待录入 CMS `publicSecurityRecord` 字段并在页脚公示（含 https://beian.mps.gov.cn/ 查询链接） |
