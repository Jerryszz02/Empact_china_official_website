...
| ICP/公安备案信息、备案覆盖确认 | 页脚和正式上线审查 | 2026-09-24 已核实：`沪ICP备2026002363号-2` 即 empact.cn 本站备案号（阿里云控制台备案信息），页脚公示正确；公安备案已办妥：`沪公网安备31010402337130号`（徐汇区网安支队，2026-09-14，主域名 empact.cn），fixture 已录入 `publicSecurityRecord` 并随页脚条件渲染公示，线上 CMS 的 Company 记录仍需补录该字段后发布。**未决**：公安备案信息中「从域名：无」，chatcircle.empact.cn 是否需作为从域名补登待确认 |
