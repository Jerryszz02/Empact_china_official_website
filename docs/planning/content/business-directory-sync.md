...
依据工作区的 `Empact网站业务目录.xlsx`，工作表为「业务目录」；初次同步于 2026-09-19；当前代码目录于 2026-09-24 按 `f8529cf` 复核。工作簿位于 `assets/业务源资料/Empact网站业务目录.xlsx`，本机工作副本可能有未提交更新。仅把表格中的业务名称、案例、链接和附件作为内容来源；负责人提醒、协作备注及空案例位不进入网站。原工作簿和既有素材整理保持原样。
