...
截至 2026-09-24，官网已在 [empact.cn](https://empact.cn/) 运行。代码核对基线为 `f8529cf`（含分组业务排序），公开发布版本按下列读取证据单独记录。本页记录当前证据和仍需人工确认的事项；[2026-09-20](history/deployment-2026-09-20.md)、[2026-09-21](history/deployment-2026-09-21.md) 的部署记录是对应日期的历史状态，不代表当前版本。
...
整理期间合入的 `f8529cfc5411f0f98a38d2adb73fd709425ab649`（分组业务排序）在 [Website checks](https://github.com/Jerryszz02/Empact_china_official_website/actions/runs/35951976485) 中失败，对应 [Deploy production](https://github.com/Jerryszz02/Empact_china_official_website/actions/runs/35952089793) 被跳过。随后公开回读仍为上述 `c32b899`。因此排序文档说明的是已合并代码能力，尚不能写成该版本已上线；后续以修复后的同 SHA 检查及公开回执为准。
