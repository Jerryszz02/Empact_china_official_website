...
// GEO intro additions: shared by the preview copy and the targeted CMS update
// (apps/cms/src/geo-intro-content-update.ts) so both never drift apart.
export const aboutServicesNeedIntro =
  "当企业希望把善意落地为可持续的行动，可以从以下三类支持找到入口。";
...
export const aboutBodyHtml =
  ...
  '在中国大陆，我们把在全球验证过的能力建设方法论，转化为适合本地议题与本地伙伴的服务形态。 企业服务由本团队承接；青少年与青年项目请见 <a href="/youth/">「青少年项目」</a> 板块。</p><h3>企业 ESG 战略咨询</h3><p>帮助跨国企业在华落地 ESG 战略，对接中国本地社会组织与公益网络， 把集团层面的可持续目标拆解为本地可执行的行动。' +
  aboutServicesBusinessLinkHtml +
  "</p><ul><li>已服务行业：科技、消费品、金融、汽车</li> <li>ESG / CSR 体系搭建与本地伙伴匹配</li></ul><h3>员工志愿者 &amp; 培训</h3><p>从社区真实需求出发，设计员工可参与、可胜任、可延续的志愿服务， 并提供行前培训、现场引导与复盘支持。" +
  aboutServicesBusinessLinkHtml +
  "</p><ul><li>标准化课程 + 定制化项目</li> <li>覆盖青年领导力、跨文化沟通、影响力测量</li></ul><h3>影响力传播 &amp; 报告</h3><p>把企业「做了什么」翻译成投资人、公众看得懂的叙事， 让公益投入被清楚地看见、被准确地引用。</p><ul><li>白皮书撰写、案例视频、行业奖项申报</li> <li>基于变革理论的成效评估报告</li></ul>" +
