...
const businessRows: Array<[string, string, Segment, string, string]> = [
  ...
  [
    ...
    "当青少年希望走出课堂、接触真实的社会议题与工作环境时，公益社创体验提供三类入口：国际研学营、本地月月营和办公室实训。国际研学围绕新加坡、中国香港与日本等目的地展开；本地月月营连接公益机构、SDGs 游戏、企业参访与年度交流；办公室实训提供上海与新加坡的实践场景。学员在观察、提问、服务与协作中，把所学带入真实任务。具体行程与参与安排请查看各项目介绍。",
  ],
  [
    "public-speaking",
    "演讲类表达",
    ...
    "当青少年有自己的观察想说出来、却还不确定怎样讲清楚时，演讲类表达提供从整理想法到公开分享的练习路径，包括 TEDx、Empact 少年说和演讲×社会创新赋能营。学习从学员关心的问题出发，经过选题、材料整理、观点组织和表达练习，逐步形成面向听众的分享。社会创新实践也为演讲提供可以观察、讨论和反思的内容。",
  ],
  [
    ...
    "当青少年需要理解 AI、并学会判断和检验工具的产出时，AI学习力课程把 AI 放进具体项目任务中学习。课程涵盖 AI×PBL、线上 AI×思辨、线下 Vibe Coding、AI 公益课与白名单赛事培训，学员在任务中练习理解问题、使用工具、检验结果和表达想法。不同课程的安排及参与要求，请查看对应项目内容。",
  ],
  [
    ...
    "youth",
    "关注自我觉察、情绪理解与人际沟通。",
    "青少年如何认识自己、理解情绪，并在与他人的互动中练习表达、倾听和协作，是 SEL社会情感学习关注的方向。课程正在筹备中，欢迎联系团队了解后续安排。",
  ],
  [
    "student-stories",
    "学员故事与家长说",
    ...
    "当家长和学员想了解真实的参与体验时，可以在这里看到第一手的记录。学员故事与家长说将汇集学员视频、家长分享与活动反馈，记录参与者自己的观察、感受与收获。欢迎联系团队交流项目体验与成长记录。",
  ],
  [
    "volunteering",
    "企业志愿者、CSR与公益咨询",
    ...
    "当企业希望回应社会需求、让员工真正参与公益，却不确定从何开始时，需要理解双方需求的合作设计。企业志愿者、CSR与公益咨询连接企业、公益机构与社区需求，合作内容包括志愿服务设计、员工参与、公益项目策划和实施支持，帮助企业明确项目目标、组织参与过程并整理反馈。",
  ],
  [
    ...
    "当组织希望探索 AI 应用、又需要从具体任务而非概念出发时，AI×组织变革与智能赋能面向组织学习和业务实践，关注团队如何理解 AI、识别适用场景，并将工具尝试与工作中的问题结合。课程和工作坊根据团队需求设计，支持讨论、体验与行动计划。",
  ],
  [
    ...
    "当管理者希望跳出讲座式培训、在真实情境中观察和改善团队协作时，领导力激发与体验创新通过体验活动和团队讨论，把协作问题带到具体情境中。参与者在互动中观察自己的选择，交流不同视角，再通过复盘梳理可以带回工作的做法。",
  ],
  [
    ...
    "当团队希望正视工作中的压力、为成员提供交流与支持的空间时，职场心理韧性培养与压力释放关注压力体验、自我觉察与同伴支持。通过课程、体验和交流，帮助参与者认识自己的状态，练习沟通与日常调适，并讨论团队可以提供的支持。本方向为学习与交流支持，不涉及医疗或心理治疗。",
  ],
  [
    ...
    "corporate",
    "连接管理学习、社会创新与真实组织议题。",
    "当商学院或管理教育者希望把真实组织情境带入课堂时，商学院管理创新学科课程把管理知识与真实组织情境结合，通过案例讨论、体验学习和项目任务，支持学习者探索管理实践与社会创新之间的联系。课程主题和形式可根据教学需求共同设计。",
  ],
  [
    ...
    "当中国公益品牌希望走向海外、需要理解目标环境并连接在地伙伴时，这一方向提供目标国家调研、法律主体落地支持、本地生态伙伴对接、路演安排和影响力评估的一站式服务。通过连接政府、公益机构等在地伙伴，协助公益品牌理解当地环境、探索项目本地化策略，并梳理活动实施与服务对象触达的路径。其中法律主体落地支持为流程与对接协助，不构成法律意见。",
  ],
  [
    ...
    "school",
    "围绕亲子沟通与成长陪伴，练习倾听和理解。",
    "当家长、教师或陪伴者希望改善与青少年的沟通、更好地倾听和支持他们时，教练型智慧父母与青少年成长导师从亲子沟通的具体情境出发，帮助练习倾听、提问和表达，让青少年的想法能够被听见。",
  ],
  [
    ...
    "当学校希望学生围绕真实社会需求开展探究、并把 AI 作为学习工具时，AI×社会创新×PBL课程把社会体验、问题探究和作品创作放在同一学习过程中。学生通过观察、访谈和小组讨论理解需求，使用 AI 辅助整理信息与制作成果，再通过展示和反馈改进自己的表达。",
  ],
  [
    ...
    "当学校希望为学生组织演讲课程或校园表达活动时，演讲比赛及演讲辅导提供涵盖选题、原创讲稿、表达练习、彩排和现场呈现的支持。Empact 与学校共同设计活动流程，让学生有机会讲述自己的学习经历、观察和思考。",
  ],
  [
    ...
    "当个人或家庭希望参与身边的公益行动、却不确定从哪里开始时，社区志愿者机会连接希望参与公益的个人、家庭与社区伙伴。通过具体活动了解服务内容、参与方式和现场安排，在力所能及的行动中回应社区需求。",
  ],
  [
    "zhaoxi-youai",
    "朝夕有爱社区公益",
    "community",
    "通过社区陪伴与志愿参与，促进代际交流。",
    "当社区希望促进志愿者与长者之间的认识和交流时，朝夕有爱社区公益围绕社区中的陪伴与共同参与展开。项目通过活动创造彼此认识、倾听和分享的机会。具体活动内容及参与信息请查看项目介绍。",
  ],
];
